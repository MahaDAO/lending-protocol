...
import * as marketConfigs from '../../markets/main';
import * as reserveConfigs from '../../markets/main/reservesConfigs';
...
const isSymbolValid = (symbol: string, network: eEthereumNetwork) =>
  ...
  marketConfigs.MainConfig.ReserveAssets[network][symbol] &&
  marketConfigs.MainConfig.ReservesConfig[symbol] === reserveConfigs['strategy' + symbol];
...
WRONG RESERVE ASSET SETUP:
    ...
    const reserveAssetAddress =
      marketConfigs.MainConfig.ReserveAssets[localBRE.network.name][symbol];
