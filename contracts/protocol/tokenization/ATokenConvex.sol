...
contract ATokenConvex is AToken, FeeBase {
  ...
  function initialize(
    ...
    (address _rewardsContract, address _curve, address _convex) =
  ...
  function burn(
    ...
    _chargeFeeAndTransfer(convex, amount, msg.sender, _treasury);
    _chargeFeeAndTransfer(curve, amount, msg.sender, _treasury);
